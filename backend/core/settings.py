...
SECRET_KEY = 'django-insecure-d&y0&dz#fetqc_h87rvod4y+uyn9j90u*pnfolnbgrm^uox6=9'
...
INSTALLED_APPS = [
    ...
    'corsheaders',      # La sécurité (CORS)
    'rest_framework',   # Les outils d'API
    'api',              # Ton application d'audit
]
